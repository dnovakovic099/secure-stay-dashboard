            ...
            <form
                ...
                <div className='grid grid-flow-col gap-4'>
                    <div className='col-span-8 space-y-4'>
                        <div className='grid space-y-2 w-full '>
                            <label htmlFor="" className='text-indigo-900 font-semibold'>Full name</label>
                            <input
                                name='fullName'
                                type='text'
                        ...
                        <div className='grid space-y-2 w-full '>
                            <label htmlFor="" className='text-indigo-900 font-semibold'>Email</label>
                            <input
                                name='email'
                                type='text'
                        ...
                        <div className='grid space-y-2 w-full '>
                            <label htmlFor="" className='text-indigo-900 font-semibold'>Contact</label>
                            <div className='flex border  shadow-sm rounded-md '>
                                <select
                                    name="country"
                                    id=""
                                    className='rounded-l-md py-2 outline-none shadow-sm'
                ...
                <div className='flex space-x-5 justify-center  '>
                    <button
                        ...
                        className='px-4 py-2 bg-indigo-600 text-white rounded-md w-full'>Save</button>
                    <button
