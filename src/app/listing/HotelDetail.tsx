...
import { MapIcon, UserIcon } from '@heroicons/react/20/solid';
  ...
  return (
    <div className="m-6 flex gap-8 p-4 rounded-md bg-white shadow-lg relative">
      <div className="flex flex-col gap-4">
        ...
        <div className="relative rounded-lg overflow-hidden h-[58vh]">
          <div className="">
            <Image
          ...
          <div className="absolute bottom-0 left-0 p-6 text-white bg-transparent w-full">
            ...
            <div className="flex items-center text-white">
              <MapIcon className="block h-4 w-4 text-white hover:text-gray-500" />
        ...
        <div
          className={classNames(
            'flex items-center justify-between p-4 gap-5 rounded-md w-[25vw]',
      ...
      <div className="w-full flex justify-center items-start">
        <div className="w-full">
              ...
              <div className="bg-slate-50 rounded-md p-1">
                <div className="flex justify-between">
                  ...
                  <button
                    id="1"
                    className={classNames(
                      'px-6 py-2 rounded-md cursor-pointer text-sm font-semibold text-gray-800 hover:bg-white hover:shadow-md transition duration-300',
                  ...
                  {/* Other Buttons for Different Tabs */}
                  <button
                    id="2"
                    className={classNames(
                      'px-6 py-2 rounded-md cursor-pointer text-sm font-semibold text-gray-800 hover:bg-white hover:shadow-md transition duration-300',
                  ...
                  <button
                    ...
                    className={classNames(
                      'px-6 py-2 rounded-md cursor-pointer text-sm font-semibold text-gray-800 hover:bg-white hover:shadow-md transition duration-300',
                      activeTab === 'images' && 'bg-white shadow-md ',
                    )}
          ...
          {activeTab === 'C&C' && <CheckInandOut selectedItem={selectedItem} />}
