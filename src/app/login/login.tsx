...
const Login = () => {
    ...
    const handleSubmit = async (event: { preventDefault: () => void; }) => {
        ...
        if (user && user.id) {
            const userResponse: any = await axios.get(`${envConfig.backendUrl}/pmcompay/userpmlist?uid=${user.id}`, {});
            ...
            <div className='relative flex flex-col  bg-[#141B37] right-0 h-screen'>
                <div className='relative flex right-0 justify-end overflow-hidden'>
                    <svg
                        ...
                        width="650" height="300" viewBox="0 0 396 406" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M232.982 0H395.56L166.746 406H0L232.982 0Z" fill="url(#paint0_linear_1300_4416)" fillOpacity="0.5" />
                        <defs>
                            <linearGradient id="paint0_linear_1300_4416" x1="395.56" y1="-161.82" x2="77.72" y2="425.72" gradientUnits="userSpaceOnUse">
                                <stop stopColor="#7F91D8" stopOpacity="0.33" />
                                <stop offset="1" stopColor="#737373" stopOpacity="0" />
                            </linearGradient>
                        </defs>
                    </svg>
                    <svg className='fixed mt-24' width="460" height="160" viewBox="0 0 525 191" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M585.908 55.5312L542.736 190.154L0.499978 117L72.0001 0.706953L585.908 55.5312Z" fill="url(#paint0_linear_1300_4392)" fillOpacity="0.6" />
                        <defs>
                            <linearGradient id="paint0_linear_1300_4392" x1="676.732" y1="135.113" x2="82.1064" y2="71.7709" gradientUnits="userSpaceOnUse">
                                <stop stopColor="#7F91D8" stopOpacity="0.33" />
                                <stop offset="1" stopColor="#737373" stopOpacity="0" />
                            </linearGradient>
                        </defs>
            ...
            <div className='flex flex-1 justify-center h-[100%] bg-gray-50'>
                ...
                <div className=" flex justify-center items-center sm:mx-auto  sm:w-full  ">
                    <div className="bg-white py-4 px-4 shadow-md sm:rounded-lg sm:px-6 min-w-[402px]">
                        ...
                        <form className="space-y-1" onSubmit={(event) => handleSubmit(event)}>
                                <div className='h-20'>
                                    <label
                                        htmlFor="email"
                            ...
                            <div className='h-20'>
                                ...
                                <div className="flex items-center justify-end pt-2">
                                    ...
                                    <div className="text-sm">
                                        <a
                                            href="#"
                                            className=" text-[#7000FF] hover:text-blue-900"
                                        >
                            ...
                            <div className='pt-4'>
                                ...
                                <button
                                    className="flex text-gray-500 py-2  w-full justify-center rounded-md border bg-gradient-to-br font-medium focus:outline-none"
                                >
                                    <svg className='mr-2' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="24" height="24" fill="white" />
                                        <path fill-rule="evenodd" clipRule="evenodd" d="M23.04 12.2615C23.04 11.446 22.9668 10.6619 22.8309 9.90918H12V14.3576H18.1891C17.9225 15.7951 17.1123 17.013 15.8943 17.8285V20.714H19.6109C21.7855 18.7119 23.04 15.7637 23.04 12.2615Z" fill="#4285F4" />
                                        <path fill-rule="evenodd" clipRule="evenodd" d="M11.9995 23.4998C15.1045 23.4998 17.7077 22.47 19.6104 20.7137L15.8938 17.8282C14.864 18.5182 13.5467 18.9259 11.9995 18.9259C9.00425 18.9259 6.46902 16.903 5.5647 14.1848H1.72266V17.1644C3.61493 20.9228 7.50402 23.4998 11.9995 23.4998Z" fill="#34A853" />
                                        <path fill-rule="evenodd" clipRule="evenodd" d="M5.56523 14.185C5.33523 13.495 5.20455 12.7579 5.20455 12C5.20455 11.242 5.33523 10.505 5.56523 9.81499V6.83545H1.72318C0.944318 8.38795 0.5 10.1443 0.5 12C0.5 13.8557 0.944318 15.612 1.72318 17.1645L5.56523 14.185Z" fill="#FBBC05" />
                                        <path fill-rule="evenodd" clipRule="evenodd" d="M11.9995 5.07386C13.6879 5.07386 15.2038 5.65409 16.3956 6.79364L19.694 3.49523C17.7024 1.63955 15.0992 0.5 11.9995 0.5C7.50402 0.5 3.61493 3.07705 1.72266 6.83545L5.5647 9.815C6.46902 7.09682 9.00425 5.07386 11.9995 5.07386Z" fill="#EA4335" />
                                    </svg>
