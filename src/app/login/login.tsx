...
const Login = () => {
  ...
  const googleLoginProvider = async () => {
    await getUserSubscriptionInfo('google');
  };

  const emailLoginProvider = async () => {
    await getUserSubscriptionInfo('email');
  };

  const getPmInfoGoogle = async () => {
    try {
  ...
  const getUserSubscriptionInfo = async (provider: string) => {
    try {
              ...
              <div className="h-20">
                ...
                <div className="flex items-center justify-end pt-2">
                  <div className="text-sm">
                    <a href="/forgetPassword" className=" text-[#7000FF] hover:text-blue-900">
