  ...
  return (
    <>
      <div
        ...
        className={`px-6 mr-4 ${
          lockType == "Seam" ? "mt-14" : "mt-4"
        } bg-gray-100 mb-2 py-3 rounded-md cursor-pointer select-none flex justify-between items-center transition duration-300 ease-in-out transform`}
      >
        <p className="text-gray-700 font-semibold text-sm">
          Connected Listings{" "}
          <span className="text-slate-400">({connectedListings.length})</span>
        </p>
        <div className="">
          <button
