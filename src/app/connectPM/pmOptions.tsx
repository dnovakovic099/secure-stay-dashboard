...
const PMOptions = () => {
  ...
  const getPmList = async () => {
    try {
      const response = await axiosInstance.get(
        `${envConfig.backendUrl}/pm/getpmlist`,
        {
          headers: {
  ...
  const saveUsersPM = async (pmId: number) => {
    ...
    try {
      ...
      const response: any = await axiosInstance.post(
        `${envConfig.backendUrl}/pmcompay/saveuserpmcompany`,
        pmData
      );
  ...
  const checkUsersPM = async () => {
    ...
    const userResponse: any = await axiosInstance.get(
      `${envConfig.backendUrl}/pmcompay/userpmlist?uid=${uid} `,
      {}
    );
      ...
      <div className=" border-2 rounded-xl py-5 px-5 border-gradient-to-br from-indigo-600 via-indigo-700 to-indigo-800">
        ...
        <div className="text-center mt-10 ">
          <button
            ...
            disabled={!selected}
            className="text-lg bg-gradient-to-br from-indigo-600 via-indigo-700 to-indigo-800 text-white px-10 py-1  rounded-lg "
          >
            Save
          </button>
        </div>
      ...
      {pmSoftwareList?.map((data) => {
        return (
          <div
            ...
            className={`m-2 rounded-2xl  border  justify-center items-center ${
              pmId === data.id ? "bg-gray-200" : ""
            }`}
          >
            <div className="mt-2 flex justify-center px-8 py-8 m-2 ">
              <img
                src={data.image}
                alt=""
                className=" justify-center max-h-[30px] min-h-[30px] "
              />
            </div>
...
const pmSoftwareList = [
  ...
  },
  {
    ...
    name: "MyVR",
    image:
      "https://gdm-catalog-fmapi-prod.imgix.net/ProductLogo/98881571-9fef-4280-b68f-54c3e6805541.png",
  },
  {
    id: 3,
    name: "Kunas",
    image:
      "https://kunas.io/wp-content/uploads/2023/03/kunas-logo-horizontal-color-300x89.png",
  },
  {
    id: 4,
    name: "hoteliga",
    image:
      "https://hoteligaweb.s3.eu-central-1.amazonaws.com/Content/images/team/hoteliga_logo_EpsilonNet_black.png",
  },
  {
    id: 5,
    name: "Beds",
  ...
  },
  {
    ...
    name: "Hosthub",
    image:
      "https://www.hosthub.com/wp-content/themes/syncbnb/assets/img/hosthub-page-header-logo.svg",
  },
  {
    id: 7,
    name: "Hostify",
  ...
  },
  {
    ...
    image:
      "https://www.bookingautomation.com/wp-content/uploads/2019/03/Group-415.png",
  },
  {
    id: 9,
    name: "MEWS",
  ...
  },
  {
    ...
    name: "Guesty",
    image:
      "https://www.guesty.com/wp-content/uploads/2023/07/guesty-logo-new.svg",
  },
  {
    id: 12,
    name: "RMS Cloud",
    image:
      "https://www.rmscloud.com/hubfs/RMS%20GLB%20Website%2022/RMS_2022/icons/rms-logo.svg",
  },
];
