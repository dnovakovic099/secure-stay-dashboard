...
const AccountSettings = ({ data, popupTitle, setPopupTitle }: any) => {
    ...
    const items = [
        <div key={1} className='flex justify-center items-center px-8 h-72'>{firstItem()}</div>,
        <div key={2} className='flex justify-center items-center px-8 h-72'>{secondItem()}</div>,
    ];
