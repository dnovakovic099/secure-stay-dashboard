  ...
  return (
    <div className="flex justify-center w-[16rem] h-[532px] bg-[#141B37] border-2 border-gray-700 rounded-[2.5rem] overflow-hidden shadow-lg mx-10">
      <div className="relative w-[15rem] border-2 rounded-[2rem] h-[514px] my-2 bg-white">
        ...
        {/* Screen content */}
        <div className="flex-1 justify-start bg-white overflow-hidden px-2 h-[465px]">
          <div className="text-center text-indigo-700 text-sm mb-2">
          ...
          <div className="flex flex-col justify-between item-start mt-4 h-[290px]">
            <div>
            ...
            <div>
              <button
                ...
                className="text-sm font-medium bg-gradient-to-r from-[#9E49F2] to-[#7000FF] text-[#FFFFFF] px-5 py-[10px] w-full rounded-lg"
              >
                Purchase
              </button>
            </div>
