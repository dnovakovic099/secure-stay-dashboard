    ...
    <div>
      ...
      <div>
        ...
        <div
          ...
          className="px-6 bg-slate-200 py-2 rounded-md cursor-pointer select-none flex justify-between"
        >
        ...
        {showListings &&
          listings.map((listing: listing) => (
            ...
            <div
              className="flex gap-4 p-4 items-center cursor-pointer select-none"
              onClick={() => setSelectedListing(listing)}
            >
              <input
                type="checkbox"
                checked={selectedListing?.id == listing.id}
                name=""
                id=""
